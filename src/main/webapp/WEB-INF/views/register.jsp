			...
			<section class="main-content">				
				<div class="row">
					...
					<div class="span7">					
						...
						<form:form method="POST" action="register" modelAttribute="customerForm" class="form-stacked">
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="emailAddress" placeholder="Enter your email" class="input-xlarge">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Password:</label>
