...
@ComponentScans(value = { @ComponentScan("com.shopper.dao"),
      @ComponentScan("com.shopper.service") })
public class AppConfig {
   ...
   public LocalSessionFactoryBean getSessionFactory() {
      ...
      props.put(DRIVER, env.getProperty("database.driver"));
      ...
      factoryBean.setPackagesToScan("com.shopper.model");
